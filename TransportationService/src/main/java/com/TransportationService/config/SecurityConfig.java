    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(request -> request.requestMatchers("/auth/**")
                        ...
                        .requestMatchers("/driver/**").hasAnyAuthority(Role.DRIVER.name())
                        .requestMatchers("/customer/**").hasAnyAuthority(Role.CUSTOMER.name())
                        .requestMatchers("/fare/**").hasAnyAuthority(Role.CUSTOMER.name())
                        .requestMatchers("/cab/**").hasAnyAuthority(Role.DRIVER.name(),Role.ADMIN.name())
                        .requestMatchers("/ride/**").hasAnyAuthority(Role.CUSTOMER.name())
